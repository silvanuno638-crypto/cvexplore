  ...
  return (
    <nav className="fixed top-0 w-full z-50 bg-white shadow-sm border-b border-blue-100">
      <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
        ...
        `}>
          <Link onClick={closeMenu} href="/" className="text-2xl font-bold text-blue-600 border-b-2 border-blue-600">História</Link>
          <Link onClick={closeMenu} href="/ilhas" className="text-2xl font-bold text-blue-600 border-b-2 border-blue-600">As 10 Ilhas</Link>
